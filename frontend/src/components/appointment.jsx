...
const BookAppointment = () => {
  ...
  // ── UI state ──
  const [step, setStep]       = useState("symptoms");  // symptoms | result | booking | done
      ...
      <div className="appointment-container">
        ...
        {step === "done" && (
          <div className="result-section" style={{ textAlign: "center" }}>
            ...
            <button className="book-btn" onClick={() => { setStep("symptoms"); setSelectedSymptoms(Array(MAX_SELECTIONS).fill("")); setDisease(""); setDoctors([]); }}>
              Book Another
            </button>
          </div>
        )}
